...
export function createViews({ api, store, openModal, openPage = (_page, title, content) => { openModal(title, content); return content; }, toast, refresh }) {
  ...
  function openExecution() {
    ...
    const codexEnabled = el('input', { type: 'checkbox', checked: settings.codexEnabled }); const codexAgentsEnabled = el('input', { type: 'checkbox', checked: settings.codexAgentsEnabled }); const antiEnabled = el('input', { type: 'checkbox', checked: settings.antigravityEnabled }); const chatOverride = el('input', { type: 'checkbox', checked: settings.allowChatOverride });
