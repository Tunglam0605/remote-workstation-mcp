...
export const CAPABILITIES: CapabilityDescriptor[] = [
  ...
  { id: 'process.execute', status: 'available', tools: ['process_start', 'process_read', 'process_read_since', 'process_list', 'process_stop'], note: 'Executable allowlist in normal modes; shell=false.' },
  ...
  { id: 'full_control.shell', status: 'available', tools: ['shell_exec'], note: 'Requires full-control lease plus explicit raw-shell policy gate.' },
  { id: 'full_control.admin', status: 'available', tools: ['admin_exec'], note: 'Non-interactive sudo only; requires full-control lease, policy gate and OS sudo policy.' },
