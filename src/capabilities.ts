...
export const CAPABILITIES: CapabilityDescriptor[] = [
  ...
  { id: 'build.diagnostics', status: 'available', tools: ['build_diagnostics'], note: 'Token-efficient structured GCC/Clang/MSVC/CMake diagnostics parsed from managed process output.' },
