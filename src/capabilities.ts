...
export const CAPABILITIES: CapabilityDescriptor[] = [
  ...
  { id: 'engineering.serial', status: 'available', tools: ['serial_open', 'serial_read', 'serial_write', 'serial_close'], note: 'Caller-owned serial sessions use bounded buffers; serial write is separately permission-gated.' },
  { id: 'engineering.firmware', status: 'available', tools: ['firmware_project_inspect', 'firmware_artifacts', 'firmware_build', 'firmware_flash_plan', 'firmware_flash', 'firmware_verify', 'target_reset'], note: 'Typed firmware workflows auto-detect ESP-IDF/STM32/CMake/Make and use constrained provider-generated argv.' },
  ...
  { id: 'engineering.ros2', status: 'available', tools: ['ros2_node_list', 'ros2_topic_list', 'ros2_topic_echo', 'ros2_service_list', 'ros2_service_call', 'ros2_action_list', 'ros2_param_list', 'ros2_param_get', 'ros2_param_set', 'ros2_bag_record'], note: 'Bounded ros2cli contracts separate read-only graph inspection from runtime mutation.' },
