...
export const CAPABILITIES: CapabilityDescriptor[] = [
  ...
  { id: 'process.execute', status: 'available', tools: ['process_start', 'process_read', 'process_read_since', 'process_list', 'process_stop'], note: 'Executable allowlist in all modes; shell=false. Managed process IDs/output are isolated to the creating authenticated principal or fallback local client profile.' },
  ...
  { id: 'code.semantic', status: 'planned', tools: [], note: 'LSP-backed definition/reference/diagnostic/refactor tools are the next direct-control layer.' },
