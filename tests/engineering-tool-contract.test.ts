...
test('v0.23.5 stable exposes Execution Policy on Action Schema v7 and keeps Engineering API v4', async () => {
  ...
  assert.match(capabilities, /export const SERVER_VERSION = '0\.23\.5';/);
