...
test('v0.31.3 stable exposes Antigravity worker integration on Action Schema v11 and Engineering API v5', async () => {
  ...
  assert.match(capabilities, /export const SERVER_VERSION = '0\.31\.3';/);
