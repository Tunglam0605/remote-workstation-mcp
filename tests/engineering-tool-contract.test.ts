...
test('v0.25.1 stable exposes Codex Account Broker on Action Schema v10 and Engineering API v5', async () => {
  ...
  assert.match(capabilities, /export const SERVER_VERSION = '0\.25\.1';/);
