...
test('v0.32.3 stable exposes hardened Codex/EAS and Antigravity worker integration on Action Schema v11 and Engineering API v5', async () => {
  ...
  assert.match(capabilities, /export const SERVER_VERSION = '0\.32\.3';/);
